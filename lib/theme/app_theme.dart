...
class AppTheme {
  ...
  // Professional Market Palette - Color specifications
  ...
  static const Color errorLight =
      Color(0xFFC62828); // Professional red for losses
  static const Color successLight =
      Color(0xFF2E7D32); // Standard green for gains
  static const Color accentLight = Color(0xFFFF6F00); // Orange for alerts
  ...
  // Shadow colors - elevation-based with maximum 4dp for cards, 8dp for modals
  static const Color shadowLight = Color(0x1A000000);
  static const Color shadowDark = Color(0x1AFFFFFF);

  // Divider colors - subtle gray for minimal separations
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    // AppBar with gradient support for navigation hierarchy
    ...
    // Bottom navigation optimized for financial data access
    ...
    // Drawer theme with gradient support
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      headlineLarge: GoogleFonts.poppins(
        fontSize: 32,
        fontWeight: FontWeight.w600, // SemiBold for navigation headers
        color: textPrimary,
      ),
  ...
  static const Color positiveGreen = successLight;
  static const Color negativeRed = errorLight;
  static const Color alertOrange = accentLight;
  static const Color neutralGray = textSecondaryLight;

  static const Color positiveGreenDark = successDark;
  static const Color negativeRedDark = errorDark;
  static const Color alertOrangeDark = accentDark;
  static const Color neutralGrayDark = textSecondaryDark;

  /// Data-specific text styles using monospace fonts
  static TextStyle dataTextStyle(
      {required bool isLight, double fontSize = 14}) {
    return GoogleFonts.poppins(
      fontSize: fontSize,
      fontWeight: FontWeight.w500, // Medium for precise data alignment
      color: isLight ? textPrimaryLight : textPrimaryDark,
      letterSpacing: 0.0, // Monospace doesn't need additional spacing
    );
  }

  /// Price change text styles with color coding
  static TextStyle priceChangeTextStyle({
    ...
    Color color;
    if (isPositive) {
      color = isLight ? positiveGreen : positiveGreenDark;
    } else {
      color = isLight ? negativeRed : negativeRedDark;
    }
